...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Function<Customer, Integer> function = customer -> customer.getAge();
        Stream<Integer> sortedAgeStream = customerList.stream().map(function).sorted();
    ...
    public void descSortByAge() {
         ...
         */
        Function<Customer,Integer> function = customer -> customer.getAge();
        Comparator<Customer> descOrder = (customer1,customer2) -> customer2.getAge()-customer1.getAge();
        Stream<Integer> sortedAgeStream = customerList.stream().sorted(descOrder).map(function);
    ...
    public void top3RichCustomer() {
         ...
         */
        Function<Customer,String> function = customer -> customer.getName();
        Comparator<Customer> comparator = (customer1,customer2) -> customer2.getBudget() - customer1.getBudget();
        Stream<String> top3RichCustomerStream = customerList.stream().sorted(comparator).map(function).limit(3);
    ...
    public void distinctAge() {
         ...
         */
        Function<Customer,Integer> function = customer -> customer.getAge();
        Stream<Integer> distinctAgeStream = customerList.stream().map(function).distinct();
